...
void InitCmdTable(CmdTable* cmd_table) {
  ...
  //   ////Ehsetnx
  //   std::unique_ptr<Cmd> ehsetnxptr =
  //       std::make_unique<PKHSetnxCmd>(kCmdNamePKHSetnx, 4, kCmdFlagsWrite | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHSetnx, std::move(ehsetnxptr)));
  ////Ehsetex
  //   std::unique_ptr<Cmd> ehsetexptr =
  //       std::make_unique<PKHSetexCmd>(kCmdNamePKHSetex, 5, kCmdFlagsWrite | kCmdFlagsPKHash);
  ...
  //   ////Ehexists
  //   std::unique_ptr<Cmd> ehexistsptr =
  //       std::make_unique<PKHExistsCmd>(kCmdNamePKHExists, 3, kCmdFlagsRead | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHExists, std::move(ehexistsptr)));
  //   ////Ehdel
  //   std::unique_ptr<Cmd> ehdelptr = std::make_unique<PKHDelCmd>(kCmdNamePKHDel, -3, kCmdFlagsWrite |
  //   kCmdFlagsPKHash); cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHDel,
  //   std::move(ehdelptr)));
  //   ////Ehlen
  //   std::unique_ptr<Cmd> ehlenptr = std::make_unique<PKHLenCmd>(kCmdNamePKHLen, -2, kCmdFlagsRead | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHLen, std::move(ehlenptr)));
  //   ////Ehstrlen
  //   std::unique_ptr<Cmd> ehstrlenptr =
  //       std::make_unique<PKHStrlenCmd>(kCmdNamePKHStrlen, 3, kCmdFlagsRead | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHStrlen, std::move(ehstrlenptr)));
  //   ////Ehincrby
  //   std::unique_ptr<Cmd> ehincrbyptr =
  //       std::make_unique<PKHIncrbyCmd>(kCmdNamePKHIncrby, -4, kCmdFlagsWrite | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHIncrby, std::move(ehincrbyptr)));
  //   ////Ehincrbyfloat
  //   std::unique_ptr<Cmd> ehincrbyfloatptr =
  //       std::make_unique<PKHIncrbyfloatCmd>(kCmdNamePKHIncrbyfloat, -4, kCmdFlagsWrite | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHIncrbyfloat,
  //   std::move(ehincrbyfloatptr)));
  //   ////Ehmset
  //   std::unique_ptr<Cmd> ehmsetptr = std::make_unique<PKHMsetCmd>(kCmdNamePKHMSet, -4, kCmdFlagsWrite |
  //   kCmdFlagsPKHash); cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHMSet,
  //   std::move(ehmsetptr)));
  //   ////Ehmsetex
  //   std::unique_ptr<Cmd> ehmsetexptr =
  //       std::make_unique<PKHMsetnxCmd>(kCmdNamePKHMSetex, -5, kCmdFlagsWrite | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHMSetex, std::move(ehmsetexptr)));
  //   ////Ehmget
  //   std::unique_ptr<Cmd> ehmgetptr = std::make_unique<PKHMgetCmd>(kCmdNamePKHMGet, -3, kCmdFlagsRead |
  //   kCmdFlagsPKHash); cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHMGet,
  //   std::move(ehmgetptr)));
  //   ////Ehkeys
  //   std::unique_ptr<Cmd> ehkeysptr = std::make_unique<PKHKeysCmd>(kCmdNamePKHKeys, 2, kCmdFlagsRead |
  //   kCmdFlagsPKHash); cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHKeys,
  //   std::move(ehkeysptr)));
  //   ////Ehvals
  //   std::unique_ptr<Cmd> ehvalsptr = std::make_unique<PKHValsCmd>(kCmdNamePKHVals, 2, kCmdFlagsRead |
  //   kCmdFlagsPKHash); cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHVals,
  //   std::move(ehvalsptr)));
  //   ////Ehgetall
  //   std::unique_ptr<Cmd> ehgetallptr =
  //       std::make_unique<PKHGetallCmd>(kCmdNamePKHGetall, -2, kCmdFlagsRead | kCmdFlagsPKHash);
  //   cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHGetall, std::move(ehgetallptr)));
  //   ////Ehscan
  //   std::unique_ptr<Cmd> ehscanptr = std::make_unique<PKHScanCmd>(kCmdNamePKHScan, -3, kCmdFlagsRead |
  //   kCmdFlagsPKHash); cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHScan,
  //   std::move(ehscanptr)));
  ...
  std::unique_ptr<Cmd> rpushxptr = std::make_unique<RPushxCmd>(kCmdNameRPushx, -3, kCmdFlagsWrite | kCmdFlagsList);
